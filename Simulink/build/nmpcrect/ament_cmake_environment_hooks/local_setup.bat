...
set "AMENT_ENVIRONMENT_HOOKS[nmpcrect]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[nmpcrect] "%AMENT_CURRENT_PREFIX%\share\nmpcrect\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[nmpcrect] "%AMENT_CURRENT_PREFIX%\share\nmpcrect\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[nmpcrect]:;=";"%") do (
    call:call_file %%f
  )

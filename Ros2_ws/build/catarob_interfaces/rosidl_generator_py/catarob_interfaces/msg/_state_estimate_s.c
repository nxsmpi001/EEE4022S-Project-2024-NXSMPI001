...
bool catarob_interfaces__msg__state_estimate__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("catarob_interfaces.msg._state_estimate.StateEstimate", full_classname_dest, 52) == 0);
  }
  catarob_interfaces__msg__StateEstimate * ros_message = _ros_message;
  {  // x
...
PyObject * catarob_interfaces__msg__state_estimate__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("catarob_interfaces.msg._state_estimate");
